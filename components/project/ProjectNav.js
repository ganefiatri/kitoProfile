    ...
    return (
        <div>
            <ul className="nav nav-pills flex flex-col md:flex-row list-none pl-0 mb-4" id="pills-tabFill" role="tablist">
                ...
                <li className="nav-item flex-auto text-center my-2 md:ml-2" role="presentation">
            ...
            <div className="tab-content" id="pills-tabContentFill">
                <div className="tab-pane fade show active pb-10" id="pills-homeFill" role="tabpanel" aria-labelledby="pills-home-tabFill">
                ...
                <div className="tab-pane fade" id="pills-profileFill" role="tabpanel" aria-labelledby="pills-profile-tabFill">
                    <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 p-3 ml-3'>
                        {/* content */}
                ...
                <div className="tab-pane fade" id="pills-contactFill" role="tabpanel" aria-labelledby="pills-contact-tabFill">
                    <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 p-3 ml-3'>
                        {/* content */}
                ...
                <div className="tab-pane fade" id="pills-residentFill" role="tabpanel" aria-labelledby="pills-resident-tabFill">
                    <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 p-3 ml-3'>
                        {/* content */}
                ...
                <div className="tab-pane fade" id="pills-restaurantFill" role="tabpanel" aria-labelledby="pills-restaurant-tabFill">
                    <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 p-3 ml-3'>
                        {/* content */}
