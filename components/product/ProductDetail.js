...
import { MdAdUnits, MdOutlineAdUnits, MdPlace, MdProductionQuantityLimits } from 'react-icons/md';

const ProductDetail = ({ id ,img, title, price, description, quantity, subCategory, discount, place, group, unit,
titleOne,
titleTwo,
titleThree,
titleFour,
                        ...
                        <div class="flex-wrap hidden -mx-2 md:flex">
                            <div class="w-1/2 p-2 sm:w-1/4">
                                <a class="block border border-gray-200 hover:border-blue-400 dark:border-gray-700 dark:hover:border-blue-300" href="#">
                                    <img class="object-contain w-full lg:h-28" src={img} alt="" />
                                </a>
                            </div>
                            <div class="w-1/2 p-2 sm:w-1/4">
                                <a class="block border border-gray-200 hover:border-blue-400 dark:border-gray-700 dark:hover:border-blue-300" href="#">
