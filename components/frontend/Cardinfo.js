        ...
        <div className='max-w-[1240px] mx-auto px-4 sm:px-16 flex justify-center items-center'>
            <div className='pt-6'>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-x-2.5">
                    {/* About */}
                    <div className="flex p-3 justify-center items-center relative max-w-sm bg-white rounded-lg">
                        <img className="rounded-lg" src="https://images.unsplash.com/photo-1591727826491-c30be2c4fd21?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8N3x8aW50ZXJpb3IlMjBkZXNpZ24lMjB0b2lsZXQlMjBibGFja3xlbnwwfHwwfHw%3D&auto=format&fit=crop&w=600&q=60" alt="" />
                    ...
                    {/* Browse */}
                    <div className="flex p-3 justify-center items-center relative max-w-sm bg-white rounded-lg">
                        <img className="rounded-lg" src="https://images.unsplash.com/photo-1588095803059-6e4bbbe24dbb?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1yZWxhdGVkfDV8fHxlbnwwfHx8fA%3D%3D&auto=format&fit=crop&w=600&q=60" alt="" />
                        <div className="p-10 mt-14 absolute">
                            <a href="#">
                    ...
                    {/* Contact */}
                    <div className="flex p-3 justify-center items-center relative max-w-sm bg-white rounded-lg">
                        <img className="rounded-lg" src="https://images.unsplash.com/photo-1498354178607-a79df2916198?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8ZmluZCUyMHVzfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=600&q=60" alt="" />
                        <div className="p-10 mt-14 absolute">
                            <a href="#">
