    ...
    return (
        <>
            ...
            <div className='relative'>
                ...
                {/* form */}
                <div className='pt-4'>
                    <a href="https://api.whatsapp.com/send?phone=081260038883" className="w-full flex px-6 py-2.5 bg-green-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-green-700 hover:shadow-lg focus:bg-green-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-green-800 active:shadow-lg transition duration-150 ease-in-out justify-center justify-items-center items-center" target="_blank"><FaWhatsapp className='h-6 w-6 mr-2'/> Whatsapp us</a>
                </div>
            </div>
        </>
    );
