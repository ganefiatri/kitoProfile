...
const picturePage = () => {
    ...
    const fetchProject = () => {
        fetch('/api/picture/getdata').then(res => res.json().then((data) => {
            setprojects(data)
        }))
    }
    ...
    const handleButtonDelete = async (e, id) => {
        ...
        if(confirm('Are you sure want to delete this ?')){
            try {
                await fetch("/api/picture/deletedata?id=" + id, {
                    method: "DELETE",
    ...
    const column = [
        ...
        },
        {
            name: 'Images',
            grow: 0,
            cell: row => <img height="84px" width="56px" alt={row.title} src={row.img} />
        },
        {
            name: "Action",
            button: true,
            ...
            (
                <>
                    <button>
                        <Link href={`/admin/picture/edit/${row.id}`}>
        ...
        <>
            ...
            <SideNavbar>
                ...
                <div className="items-center justify-between pb-5 lg:flex xl:flex md:flex">
                    ...
                    <Link href="/admin/picture/create"
                    ...
                    >
                        ...
                        <span className="text-sm font-semibold tracking-wide">Create Picture Dashboard</span>
                    </Link>
                </div>
                <DataTable
                    columns={column}
