...
const BrandPage = () => {
    ...
    const fetchCategory = () => {
        fetch('/api/brand/getdata').then(res => res.json().then((data) => {
            setCategories(data)
        }))
    }
    ...
    const column = [
        ...
        },
        {
            ...
            (
                <>
                    <button>
                        <Link href={`/admin/brand/edit/${row.id}`}>
        ...
        <>
            ...
            <SideNavbar>
                ...
                <div class="items-center justify-between pb-5 lg:flex xl:flex md:flex">
                    <div className=''>
                        <h1 className="text-2xl font-semibold leading-relaxed text-gray-600">Brands</h1>
                        <p className="text-sm font-medium text-gray-500">
                            Let's grow to your business! Create your brands and upload here
                        </p>
                    </div>
                    ...
                    >
                        ...
                        <span className="text-sm font-semibold tracking-wide">Create Brand</span>
                    </Link>
                </div>
                <DataTable
                    columns={column}
