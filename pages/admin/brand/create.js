    ...
    const handleFormData = async (e) => {
        e.preventDefault();
           const name = e.target.name.value;
            ...
            const res = await fetch("/api/brand/createdata", {
                method: "POST",
                body:JSON.stringify({
                    name: name,
                }),
            ...
            <SideNavbar>
                ...
                <section>
                    <div className='flex border-b border-dashed border-border-base py-5 sm:py-8'>
                        <h1 className='text-lg font-semibold text-heading'>Create New Brand</h1>
                    </div>
                    <form onSubmit={handleFormData}>
                        <div className='my-5 flex flex-wrap sm:my-8'>
                            <div className='w-full px-0 pb-5 sm:w-4/12 sm:py-8 sm:px-4 md:w-1/3 md:py-5'>
                                ...
                                <p className='text-sm'>Add Brand from here</p>
                            </div>
